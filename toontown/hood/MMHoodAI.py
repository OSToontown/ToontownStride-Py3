...
class MMHoodAI(HoodAI.HoodAI):
    ...
    def startup(self):
        ...
        self.trickOrTreatMgr.generateWithRequired(4835) # Ursatz for Really Kool Katz, Cactus Court

        self.winterCarolingMgr = DistributedEffectMgrAI.DistributedEffectMgrAI(self.air, ToontownGlobals.CHRISTMAS, 14)
        self.winterCarolingMgr.generateWithRequired(4614) # Shave and a Haircut for a Song, Desert Drive
