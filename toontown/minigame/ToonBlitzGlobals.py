...
GameDuration = {ToontownGlobals.ToonIslandCentral: 150,
 ...
 ToontownGlobals.DaisyGarden: 140,
...
BaseBonusOnCompletion = {ToontownGlobals.ToonIslandCentral: 15,
 ...
 ToontownGlobals.DaisyGarden: 19,
...
SectionWeights = {ToontownGlobals.ToonIslandCentral: ((0, 25),
 ...
 ToontownGlobals.RainbowRise: ((0, 15),
                               ...
                               (4, 10),
                               (5, 10)),
 ToontownGlobals.DaisyGarden: ((0, 15),
                                (1, 15),
                                (2, 25),
                                (3, 25),
                                (4, 10),
...
PercentMaxEnemies = {ToontownGlobals.ToonIslandCentral: 50,
 ...
 ToontownGlobals.DaisyGarden: 70,
...
PercentMaxTreasures = {ToontownGlobals.ToonIslandCentral: 100,
 ...
 ToontownGlobals.DaisyGarden: 100,
...
PercentMaxSpawnPoints = {ToontownGlobals.ToonIslandCentral: 100,
 ...
 ToontownGlobals.DaisyGarden: 80,
