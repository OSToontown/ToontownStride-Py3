...
buildingMinMax = {
    ToontownGlobals.BeachballBoulevard: [config.GetInt('silly-street-building-min', 0),
                                  config.GetInt('silly-street-building-max', 3)],
    ToontownGlobals.AlohaAvenue: [config.GetInt('loopy-lane-building-min', 0),
    ...
    ToontownGlobals.CoralCourt: [config.GetInt('barnacle-boulevard-building-min', 1),
                                        config.GetInt('barnacle-boulevard-building-max', 5)],
    ToontownGlobals.OceanOverpass: [config.GetInt('seaweed-street-building-min', 1),
                                    config.GetInt('seaweed-street-building-max', 5)],
    ToontownGlobals.PiratePlace: [config.GetInt('lighthouse-lane-building-min', 1),
    ...
    ToontownGlobals.DesertDrive: [config.GetInt('alto-avenue-building-min', 3),
                                 config.GetInt('alto-avenue-building-max', 7)],
    ToontownGlobals.TumbleweedTerrace: [config.GetInt('baritone-boulevard-building-min', 3),
                                        config.GetInt('baritone-boulevard-building-max', 7)],
    ToontownGlobals.CactusCourt: [config.GetInt('tenor-terrace-building-min', 3),
    ...
    ToontownGlobals.CandyClose: [config.GetInt('lullaby-lane-building-min', 6),
                                  config.GetInt('lullaby-lane-building-max', 12)],
    ToontownGlobals.PeppermintPlace: [config.GetInt('pajama-place-building-min', 6),
...
buildingChance = {
    ToontownGlobals.BeachballBoulevard: config.GetFloat('silly-street-building-chance', 2.0),
    ToontownGlobals.AlohaAvenue: config.GetFloat('loopy-lane-building-chance', 2.0),
    ToontownGlobals.PunchlinePlace: config.GetFloat('punchline-place-building-chance', 2.0),
    ToontownGlobals.CoralCourt: config.GetFloat('barnacle-boulevard-building-chance', 75.0),
    ToontownGlobals.OceanOverpass: config.GetFloat('seaweed-street-building-chance', 75.0),
    ToontownGlobals.PiratePlace: config.GetFloat('lighthouse-lane-building-chance', 75.0),
    ...
    ToontownGlobals.DesertDrive: config.GetFloat('alto-avenue-building-chance', 95.0),
    ToontownGlobals.TumbleweedTerrace: config.GetFloat('baritone-boulevard-building-chance', 95.0),
    ToontownGlobals.CactusCourt: config.GetFloat('tenor-terrace-building-chance', 95.0),
    ...
    ToontownGlobals.CandyClose: config.GetFloat('lullaby-lane-building-chance', 100.0),
    ToontownGlobals.PeppermintPlace: config.GetFloat('pajama-place-building-chance', 100.0),
