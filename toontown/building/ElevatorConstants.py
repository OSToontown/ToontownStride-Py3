...
ElevatorData = {ELEVATOR_NORMAL: {'openTime': 0.5,
                   ...
                   'sfxVolume': 1.0,
                   'collRadius': 5},
 ELEVATOR_VP: {'openTime': 0.5,
               'closeTime': 0.5,
               'width': 11.5,
               'countdown': bboard.get('elevatorCountdown', 5.0),
               'sfxVolume': 0.7,
               'collRadius': 7.5},
 ELEVATOR_MINT: {'openTime': 0.5,
                 'closeTime': 0.5,
                 'width': 5.875,
                 'countdown': bboard.get('elevatorCountdown', 5.0),
                 'sfxVolume': 1.0,
                 'collRadius': 5},
 ELEVATOR_OFFICE: {'openTime': 0.5,
                   'closeTime': 0.5,
                   'width': 5.875,
                   'countdown': bboard.get('elevatorCountdown', 5.0),
                   'sfxVolume': 1.0,
                   'collRadius': 5},
 ELEVATOR_CFO: {'openTime': 0.5,
                'closeTime': 0.5,
                'width': 8.166,
                'countdown': bboard.get('elevatorCountdown', 5.0),
                'sfxVolume': 0.7,
                'collRadius': 7.5},
 ELEVATOR_CJ: {'openTime': 0.5,
               'closeTime': 0.5,
               'width': 15.8,
               'countdown': bboard.get('elevatorCountdown', 5.0),
               'sfxVolume': 0.7,
               'collRadius': 7.5},
 ELEVATOR_STAGE: {'openTime': 0.5,
                  'closeTime': 0.5,
                  'width': 6.5,
                  'countdown': bboard.get('elevatorCountdown', 5.0),
                  'sfxVolume': 1.0,
                  'collRadius': 9.5},
 ELEVATOR_BB: {'openTime': 0.5,
               'closeTime': 0.5,
               'width': 6.3,
               'countdown': bboard.get('elevatorCountdown', 5.0),
               'sfxVolume': 0.7,
               'collRadius': 7.5},
 ELEVATOR_COUNTRY_CLUB: {'openTime': 0.5,
                         'closeTime': 0.5,
                         'width': 5.875,
                         'countdown': bboard.get('elevatorCountdown', 5.0),
                         'sfxVolume': 1.0,
